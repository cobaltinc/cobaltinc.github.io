---
layout: post
title: "코발트 지식 공유의 날 - 9월 호"
author: "cobalt"
categories: dev
tags: [knowlegde-share-day]
image: /assets/img/2022-10-17-cobalt-knowledge-share-202210/thumbnail.png
comments: true
---
...
대부분의 IT 회사들이 애자일 방법론으로 일하고 있습니다. 그런데 과연 우리는 애자일에 대해서 얼마나 잘 알고 있을까요? 지피지기면 백전백승이라는 말처럼 우리가 더 일을 잘하기 위해서는 애자일을 잘 알아야만 합니다. 김서현님이 Product Owner가 해야하는 업무가 무엇인지, 애자일을 잘하기 위한 방법인 스크럼은 어떻게 진행해야 하는지 지식을 공유해주셨습니다.<br />
</div>
...
<div style="margin: 10px 0">
애자일을 가장 잘하고 있는 조직은 어디일까요? 정호정님은 프로 스포츠팀이 가장 애자일한 조직이라고 합니다. 세계적으로 유명한 프로 축구 팀인 바르셀로나를 사례로 우리는 어떠한 조직이 되어야하는지 지식 공유를 해주셨습니다.<br />
</div>
...
<div style="margin: 10px 0">
애자일 조직이 되기 위해서는 구성원들의 마인드셋이 가장 중요하다고 합니다. 우리는 어떤 생각을 가지고 일해야할까요? 그에 대한 내용을 김다연님이 공유해주셨습니다.<br />
</div>
...
<div style="margin: 10px 0">
가끔씩 빠른 개발을 위해 웹 성능은 무시될 때가 많습니다. 어쩔 수 없을 때도 있지만 웹 성능은 무시할 수 없을 정도로 중요한 요소입니다. 김지은님은 웹 성능이 중요한 이유와 최적화를 하는 방법들에 대해서 공유를 해주셨습니다.<br />
</div>
...
<div style="margin: 10px 0">
코발트에서 제공하는 사이트는 신뢰성이 있을까요? 신뢰성을 확보하기 위해서는 어떻게 해야할까요? 자동화와 가용성 확보, 포스트 모템을 통해 신뢰성있는 시스템을 위한 방법을 데브옵스 개발자님이 소개해주셨습니다.<br />
</div>
